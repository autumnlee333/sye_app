...
mixin _$ReviewModel {
 ...
 String get id; String get userId; String get userName; String? get userProfilePic; String get bookId; String get bookTitle; List<String> get bookAuthors; String? get bookThumbnail; double get rating; String get reviewText; DateTime get timestamp;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,userName,userProfilePic,bookId,bookTitle,const DeepCollectionEquality().hash(bookAuthors),bookThumbnail,rating,reviewText,timestamp);

@override
String toString() {
  return 'ReviewModel(id: $id, userId: $userId, userName: $userName, userProfilePic: $userProfilePic, bookId: $bookId, bookTitle: $bookTitle, bookAuthors: $bookAuthors, bookThumbnail: $bookThumbnail, rating: $rating, reviewText: $reviewText, timestamp: $timestamp)';
}
...
@useResult
$Res call({
 String id, String userId, String userName, String? userProfilePic, String bookId, String bookTitle, List<String> bookAuthors, String? bookThumbnail, double rating, String reviewText, DateTime timestamp
});
...
/// Create a copy of ReviewModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? userName = null,Object? userProfilePic = freezed,Object? bookId = null,Object? bookTitle = null,Object? bookAuthors = null,Object? bookThumbnail = freezed,Object? rating = null,Object? reviewText = null,Object? timestamp = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String userName,  String? userProfilePic,  String bookId,  String bookTitle,  List<String> bookAuthors,  String? bookThumbnail,  double rating,  String reviewText,  DateTime timestamp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReviewModel() when $default != null:
return $default(_that.id,_that.userId,_that.userName,_that.userProfilePic,_that.bookId,_that.bookTitle,_that.bookAuthors,_that.bookThumbnail,_that.rating,_that.reviewText,_that.timestamp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String userName,  String? userProfilePic,  String bookId,  String bookTitle,  List<String> bookAuthors,  String? bookThumbnail,  double rating,  String reviewText,  DateTime timestamp)  $default,) {final _that = this;
switch (_that) {
case _ReviewModel():
return $default(_that.id,_that.userId,_that.userName,_that.userProfilePic,_that.bookId,_that.bookTitle,_that.bookAuthors,_that.bookThumbnail,_that.rating,_that.reviewText,_that.timestamp);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String userName,  String? userProfilePic,  String bookId,  String bookTitle,  List<String> bookAuthors,  String? bookThumbnail,  double rating,  String reviewText,  DateTime timestamp)?  $default,) {final _that = this;
switch (_that) {
case _ReviewModel() when $default != null:
return $default(_that.id,_that.userId,_that.userName,_that.userProfilePic,_that.bookId,_that.bookTitle,_that.bookAuthors,_that.bookThumbnail,_that.rating,_that.reviewText,_that.timestamp);case _:
  return null;
...
class _ReviewModel implements ReviewModel {
  const _ReviewModel({required this.id, required this.userId, required this.userName, this.userProfilePic, required this.bookId, required this.bookTitle, final  List<String> bookAuthors = const [], this.bookThumbnail, required this.rating, required this.reviewText, required this.timestamp}): _bookAuthors = bookAuthors;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,userName,userProfilePic,bookId,bookTitle,const DeepCollectionEquality().hash(_bookAuthors),bookThumbnail,rating,reviewText,timestamp);
...
/// Create a copy of ReviewModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? userName = null,Object? userProfilePic = freezed,Object? bookId = null,Object? bookTitle = null,Object? bookAuthors = null,Object? bookThumbnail = freezed,Object? rating = null,Object? reviewText = null,Object? timestamp = null,}) {
